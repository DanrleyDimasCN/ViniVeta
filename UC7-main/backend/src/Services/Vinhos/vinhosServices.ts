...
class VinhosServices {
    async registrar_vinhos({ nome, tipo, uva, pais, regiao, descricao, nota_media, historia, produtor, teor_alcoolico, amadurecimento, harmonizacao, olfativo, gustativo, temperatura_servico }: RegVinhos) {

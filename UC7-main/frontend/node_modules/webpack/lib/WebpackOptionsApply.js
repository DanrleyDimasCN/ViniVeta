...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\Danrley\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.411\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '2040930f98e025c15d77a7AR4ACx5WA11XBlQBVwAMVABSUgIC', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Danrley/.vscode/extensions/wallabyjs.console-ninja-1.0.411/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2040930f98e025c15d77a7AR4ACx5WA11XBlQBVwAMVABSUgIC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\Danrley\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.406\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '205ff0497bf06f52d18c31AEhfCBoJDVtUAFJVUANSVVxSVgYA', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Danrley/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '205ff0497bf06f52d18c31AEhfCBoJDVtUAFJVUANSVVxSVgYA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\danrley.dcnapoleao\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.406\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '202da968af4eca85683772B0pYARgIW1IBBgFWCAYGXgtUUlNT', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/danrley.dcnapoleao/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '202da968af4eca85683772B0pYARgIW1IBBgFWCAYGXgtUUlNT', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

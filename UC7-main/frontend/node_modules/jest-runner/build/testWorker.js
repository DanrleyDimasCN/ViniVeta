'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\Danrley\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.406\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '2016371d1ed5bd26366c7dAwEdAh9VC1MFUQcFClcCBVNVDgZU', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Danrley/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2016371d1ed5bd26366c7dAwEdAh9VC1MFUQcFClcCBVNVDgZU', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

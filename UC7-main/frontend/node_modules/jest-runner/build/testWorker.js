'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\Danrley\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.405\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '205fc3d4acd819acea2e94B1FNBkoFW1VWXAUMBFMGVAEBDgMH', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Danrley/.vscode/extensions/wallabyjs.console-ninja-1.0.405/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '205fc3d4acd819acea2e94B1FNBkoFW1VWXAUMBFMGVAEBDgMH', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
